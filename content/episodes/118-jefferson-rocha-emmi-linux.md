...
criador do [Emmi Linux](http://www.emmilinux.com.br/), uma distribuição baseada
no [Debian](https://www.debian.org/) \"simples, leve, e Brasileira\" (como diz
no site da distribuição). É com grande prazer que nós recebemos nosso
convidado, Jefferson Rocha.
...
- Como foi que nasceu o [Emmi Linux](http://www.emmilinux.com.br/)?
    Qual foi o motivo que levou à criação de uma nova distribuição GNU/Linux?
- Qual seria o chamativo para que alguém se interesse pelo Emmi Linux?
- Qual a origem do nome Emmi Linux?
- Quais foram os primeiros desafios encontrados ao iniciar com a
    distribuição?
- Os comandos do shell podem ser executados usando palavras em
    português?
- O Emmi Linux atualmente é derivado do
    [Debian](https://www.debian.org/), em algum momento no início, foi cogitado
    utilizar alguma distribuição com base Red Hat como
    [CentOS](https://www.centos.org/) ou [Fedora](https://getfedora.org/)?
- Quais são as atividades que fazem parte do dia-a-dia de manter uma
    distribuição GNU/Linux?
- Quanto tempo é dedicado para manter a distribuição?
- Por que foi escolhido o [fish shell](http://fishshell.com/) como
    shell padrão?
- Tendo o objetivo de atingir pessoas iniciantes, existe alguma
    iniciativa ou a ideia de criar um projeto pra aplicar a distribuição em
    ambiente educacional como é feito com o Linux Educacional?
- O que é o gerenciador de pacotes [Pi (Pacote
    Inteligente)](https://github.com/emmilinux/pi) e qual a sua origem? Qual a
    vantagem em usá-lo invés de usar o aptitude ou apt-get? Quais as
    tecnologias utilizadas no Pi e como contribuir com o projeto?
- O que é o [Emmi
    Instalador](https://github.com/emmilinux/emmi-instalador) e quais são as
    tecnologias utilizadas para desenvolvê-lo?
- O Emmi Linux possui LiveCD?
- Quais são os próximos passos do projeto? O que devemos esperar pelos
    próximos meses?
- Como é a comunidade do Emmi Linux e como que é o nível de suporte
    para iniciantes?
...
A [Python Brasil 13](http://2017.pythonbrasil.org.br) é a maior conferência de
Python no Brasil. Este ano o evento será em Belo Horizonte/MG entre os dias 6 e
11 de Outubro, serão: 3 dias de palestras, 2 dias de tutoriais e 1 dia de
Sprints. É esperado um numero entre 500 e 700 pessoas no evento.

Para participar basta você responder a pergunta do [formulário do
sorteio](http://bit.ly/castaliopybr13). O sorteio será realizado no dia 20 de
Setembro de 2017 às 21:00 horas ao vivo no [Canal do YouTube do Castálio
Podcast](http://youtube.com/c/CastalioPodcast), durante a gravação do próximo
episódio. Se você ainda não é inscrito, não perca tempo, assine agora mesmo e
ative as notificações para saber sobre nossas próximas gravações.
...
[Link do último sorteio](https://sorteador.com.br/sorteador/resultado/929330)
...
- [Emmi Linux](http://www.emmilinux.com.br/)
- [Pi (Pacote Inteligente)](https://github.com/emmilinux/pi)
- [Emmi Instalador](https://github.com/emmilinux/emmi-instalador)
- [Repositório Colibri](http://colibri.emmilinux.com.br/)
...
- [Meetup Ansible São Paulo](https://www.meetup.com/Ansible-Sao-Paulo/events/243212921/)
...
- [Emmi Linux no Facebook](https://www.facebook.com/emmilinux/)
- [Emmi Linux no Github](https://github.com/emmilinux)
- [Emmi Linux no Twitter](https://twitter.com/Emmi_Linux)
- [Emmi Linux no YouTube](https://www.youtube.com/channel/UCFDMd02Nr55xSPwkTJLsFRQ)
- [Shell Script para Acessibilidade (ShellSpeak)](https://www.youtube.com/watch?v=SFVxMCO2jb8)
